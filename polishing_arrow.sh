...
cd $x"_erate-0.075"
pbalign ../movie_merged_PC5.subreads.bam $x".contigs.fasta" aligned_arrow.bam
samtools faidx $x".contigs.fasta" 
variantCaller --algorithm=arrow aligned_arrow.bam --referenceFilename=$x".contigs.fasta" -j8 -o "improved_arrow_"$x".contigs.fastq" -o "improved_arrow_"$x".contigs.fasta"
